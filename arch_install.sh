...
pacstrap -K /mnt base linux linux-firmware systemd-ukify vim amd-ucode man-db man-pages texinfo sof-firmware btrfs-progs cryptsetup sbctl dracut sudo zram-generator rpcbind which gnome xorg-xwayland vulkan vulkan-tools dxvk lib32-dxvk vkd3d lib32-vkd3d wine wine-mono wine-gecko steam steam-native-runtime lib32-glu lib32-ncurses lib32-alsa-lib lib32-pulseaudio lib32-pipewire gamemode lib32-gamemode
